   ...
   <form action="{{ route('register.store') }}" method="POST">
      ...
      <div class="text-left">
         ...
         <div class="form-group">
            ...
            <input type="text" name="first_name" value="{{ old('FirstName') }}" placeholder="First Name" required>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
            ...
            <input type="text" name="last_name" value="{{ old('LastName') }}" placeholder="Last Name" required>
         </div>
         ...
         <div class="form-actions">
            ...
            <button type="button" onclick="window.location.href='/login';">Back</button>
         </div>
         <br><br><br>
      </div>
   </form>
