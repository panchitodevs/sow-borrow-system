  ...
  <div class="accordion">
    ...
    <div class="accordion-item">
      ...
      <div class="accordion-content">
        ...
        <p class="mt-4">Based on DOST‑PAGASA’s iHeatMap forecast, several locations will experience heat indices between 41–44 °C on June 10, placing them in the Danger to Extreme Danger categories.</p>
      </div>
    </div>
    ...
    <div class="accordion-item">
      <div class="accordion-header">
        <span class="accordion-title">Daily Temperature – Forecast for June 10, 2025</span>
        <span class="accordion-icon">▼</span>
      </div>
      <div class="accordion-content">
        ...
        <p class="mt-2">
          These forecasts are based on PAGASA’s 24‑hour outlook for June 10.
        </p>
      </div>
    </div>
  </div>
